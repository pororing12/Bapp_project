...
let images = [
    {
        id: 1,
        src: require("../../assets/singapore-1927733_1920.jpg"),
    },
    { id: 2, src: require("../../assets/singapore-1132358_1920.jpg"), },
    { id: 3, src: require("../../assets/buddha-tooth-relic-temple-2025388_1920.jpg"), }
]

export default class SingaporeScreen extends Component {
    constructor() {
        super()
        this.state = {
            activeImage: null
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Image
                                    source={
                                        require("../../assets/783singapore_101012.png")
                                    }
                                    style={{
                                        marginLeft: 20,
                                        marginTop: 10,
                    ...
                    <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 0 }, animatedContentStyle]}>
                        <ScrollView>
                            ...
                            <View
                                ...
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>싱가폴에서</Text>
                            ...
                            <TouchableOpacity style={{ backgroundColor: "#F8F8F8", width: 108, height: 32, borderRadius: 15, flexDirection: "row", alignItems: "center" }}>
                                ...
                                <Text style={{ color: "#7C7C7C", fontWeight: "400", marginLeft: 10 }}>싱가폴</Text>
                            </TouchableOpacity>
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/singapore-2556628_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/cable-car-2632487_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
