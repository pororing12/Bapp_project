...
let images = [
    {
        id: 1,
        src: require("../../assets/phra-nakhon-si-ayutthaya-1822502_1920.jpg"),
    },
    { id: 2, src: require("../../assets/elephant-1822492_1920.jpg"), },
    { id: 3, src: require("../../assets/roof-2436932_1920.jpg"), }
]

export default class CambodiaScreen extends Component {
    constructor() {
        super()
        this.state = {
            activeImage: null
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Image
                                    source={
                                        require("../../assets/flagofcambodia_6569.png")
                                    }
                                    style={{
                                        marginLeft: 20,
                                        marginTop: 10,
                    ...
                    <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 0 }, animatedContentStyle]}>
                        <ScrollView>
                            ...
                            <View
                                ...
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>캄보디아에서</Text>
                            ...
                            <TouchableOpacity style={{ backgroundColor: "#F8F8F8", width: 108, height: 32, borderRadius: 15, flexDirection: "row", alignItems: "center" }}>
                                ...
                                <Text style={{ color: "#7C7C7C", fontWeight: "400", marginLeft: 5 }}> 캄보디아</Text>
                            </TouchableOpacity>
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/animals-1782436_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/cambodia-439_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
