...
let images = [
    {
        id: 1,
        src: require("../../assets/sunset-3664096_1920.jpg"),
    },

    {
        id: 2,
        src: require("../../assets/gyeongju-tower-2011260_1920.jpg"),
    },

    {
        id: 3,
        src: require("../../assets/buddhism-882879_1920.jpg"),
    }
]

export default class GyeongusScreen extends Component {
    constructor() {
        super()
        this.state = {
            activeImage: null
            ...
            <View>
                ...
                >
                    ...
                    <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 0 }, animatedContentStyle]}>
                        <ScrollView>
                            <TouchableOpacity style={{ backgroundColor: "#333333", width: 48, height: 26, marginLeft: 280, justifyContent: "center" }} >
                            ...
                            <View
                                ...
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>경주에서</Text>
                            ...
                            <TouchableOpacity style={{ backgroundColor: "#F8F8F8", width: 108, height: 32, borderRadius: 15, flexDirection: "row", alignItems: "center" }}>
                                ...
                                <Text style={{ color: "#7C7C7C", fontWeight: "400", marginLeft: 20 }}>경주</Text>
                            </TouchableOpacity>
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/ruins-2081524_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/temple-1336491_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
