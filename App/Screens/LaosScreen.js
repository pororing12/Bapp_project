...
let images = [
    {
        id: 1,
        src: require("../../assets/waterfall-272654_1920.jpg"),
    },

    {
        id: 2,
        src: require("../../assets/harvesting-1822578_1920.jpg"),
    },

    {
        id: 3,
        src: require("../../assets/nature-658719_1920.jpg"),
    }
]
export default class LaosScreen extends Component {
    constructor() {
        super()
        this.state = {
            activeImage: null
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Image
                                    source={
                                        require("../../assets/flagoflaos_6483.png")
                                    }
                                    style={{
                                        marginLeft: 20,
                                        marginTop: 10,
                    ...
                    <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 0 }, animatedContentStyle]}>
                        <ScrollView>
                            ...
                            <View
                                ...
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>라오스에서</Text>
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>여행을 외치다</Text>
                            </View>
                            <TouchableOpacity style={{ backgroundColor: "#F8F8F8", width: 108, height: 32, borderRadius: 15, flexDirection: "row", alignItems: "center" }}>
                                <Image source={require("../../assets/e0183a3cac5049a09d39c1b2dbaa55cc.png")} style={{ resizeMode: "contain", width: 23, height: 23, marginLeft: 5 }} />
                                <Text style={{ color: "#7C7C7C", fontWeight: "400", }}>   라오스</Text>
                            </TouchableOpacity>
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/reclining-buddha-2065653_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/travel-3083967_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
