...
let images = [
    {
        id: 1,
        src: require("../../assets/city-1283140_1920.jpg"),
    },

    {
        id: 2,
        src: require("../../assets/batu-1090747_1920.jpg"),
    },
...
export default class MalaysiaScreen extends Component {
    constructor() {
        super()
        this.state = {
            activeImage: null
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Image
                                    source={
                                        require("../../assets/778malaysia_100488.png")
                                    }
                                    style={{
                                        marginLeft: 20,
                                        marginTop: 10,
                    ...
                    <Animated.View style={[{ flex: 1, zIndex: 1000, backgroundColor: 'white', padding: 20, paddingTop: 0 }, animatedContentStyle]}>
                        <ScrollView>
                            ...
                            <View
                                ...
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>말레이시아에서</Text>
                                <Text style={{ fontSize: 24, color: "#47525E", fontWeight: "700" }}>여행을 외치다</Text>
                            </View>
                            <TouchableOpacity style={{ backgroundColor: "#F8F8F8", width: 108, height: 32, borderRadius: 15, flexDirection: "row", justifyContent: "center", alignItems: "center" }}>
                                <Image source={require("../../assets/e0183a3cac5049a09d39c1b2dbaa55cc.png")} style={{ resizeMode: "contain", width: 23, height: 23, }} />
                                <Text style={{ color: "#7C7C7C", fontWeight: "400" }}>말레이시아</Text>
                            </TouchableOpacity>
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/malaysia-2907532_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
                            ...
                            <View
                                ...
                                <Image
                                    source={
                                        require("../../assets/legoland-malaysia-261528_1920.jpg")
                                    }
                                    style={{
                                        resizeMode: "cover",
                                        width: 150,
